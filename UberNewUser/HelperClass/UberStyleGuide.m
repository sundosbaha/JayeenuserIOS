...
{
   UIColor *regularColor= [UIColor colorWithRed:(150/255.0f) green:(201/255.0f) blue:(64/255.0f) alpha:1.0];
    return regularColor;
}

+(UIColor *)colorSecondary
{
    UIColor *regularColor= [UIColor colorWithRed:(255/255.0f) green:(213/255.0f) blue:(3/255.0f) alpha:1.0];
    return regularColor;
}
#pragma mark - Fonts
...
+ (UIFont *)fontRegular {
    ...
    return [UIFont fontWithName:@"OpenSans-Regular" size:13.0f];
}
