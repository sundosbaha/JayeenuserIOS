...
-(void)downloadFromURL:(NSString *)url
{
    if (url) {
        ...
        NSString *strImgName = [[[url stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLFragmentAllowedCharacterSet]] componentsSeparatedByString:@"/"] lastObject];
