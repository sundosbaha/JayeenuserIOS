...
- (id)initWithView:(UIView *)view withDarkTheme:(BOOL)isDarkTheme{
    self = [super initWithFrame:CGRectMake(10, 20, view.bounds.size.width-20, view.bounds.size.height-40)];
    if (self) {
        self.opaque = NO;
...
-(void)createClockView
{
    ...
    [doneButton.titleLabel setFont:[UIFont boldSystemFontOfSize:21]];
